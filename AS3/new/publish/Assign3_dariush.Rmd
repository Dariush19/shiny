...
<p>Using the next graph, we can zoom into each country and get an overview of the three categories for a selectected country. Unfortunately, the John Hopkins data does not capture state/region for many countries. Australia is an exception.
